namespace UPlan.Frame.DockForm
{
    ...
    public abstract class DockPaneStripBase : Control
    {
        ...
        protected DockPaneStripBase(UPlan.Frame.DockForm.DockPane pane)
        {
            ...
            if (m.Msg == 0x203)
            {
                ...
                if (this.DockPane.DockPanel.AllowEndUserDocking && (num != -1))
                {
                    ...
                    if (content.DockHandler.CheckDockState(!content.DockHandler.IsFloat) != DockState.Unknown)
                    {
                        ...
                        {
                            content.WillBeFloat = true;
                        }
                        else
                        {
                            content.WillBeFloat = false;
                        }
                    }
        ...
        protected UPlan.Frame.DockForm.DockPane.AppearanceStyle Appearance
        {
            get
            {
        ...
        protected UPlan.Frame.DockForm.DockPane DockPane
        {
            get
            {
