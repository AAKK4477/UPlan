...
{
    //using UPlan.Frame.DockForm.Win32;
    using System;
    ...
    [ToolboxBitmap(typeof(resfinder), "UPlan.Frame.DockForm.DockPanel.bmp"), DefaultEvent("ActiveContentChanged"), DefaultProperty("DocumentStyle"), Designer(typeof(ControlDesigner)), LocalizedDescription("DockPanel_Description")]
    public class DockPanel : Panel
    {
        ...
        private static readonly object ContentRemovingEvent = new object();
        ...
        private Size m_defaultFloatWindowSize = new Size(450, 0x116);
        ...
        private UPlan.Frame.DockForm.DocumentStyle m_documentStyle = UPlan.Frame.DockForm.DocumentStyle.DockingMdi;
        ...
        private Dictionary<DockStyle, UpZOrderHandler> m_UpZOrderMap = new Dictionary<DockStyle, UpZOrderHandler>();

        [LocalizedDescription("DockPanel_ActiveContentChanged_Description"), LocalizedCategory("Category_PropertyChanged")]
        ...
        [LocalizedDescription("DockPanel_ActiveDocumentChanged_Description"), LocalizedCategory("Category_PropertyChanged")]
        ...
        [LocalizedDescription("DockPanel_ContentRemoving_Description"), LocalizedCategory("Category_DockingNotification")]
        public event ContentClosingEventHandler ContentRemoving
        {
            add
            {
                base.Events.AddHandler(ContentRemovingEvent, value);
            }
            remove
            {
                base.Events.RemoveHandler(ContentRemovingEvent, value);
            }
        }

        public DockPanel()
        {
            this.InitUpZOrderMap();
            ...
            this.m_dummyControl = new UPlan.Frame.DockForm.DummyControl();
            ...
            base.Controls.AddRange(new Control[] { this.DockWindows[DockState.Document], this.DockWindows[DockState.DockLeft], this.DockWindows[DockState.DockRight], this.DockWindows[DockState.DockTop], this.DockWindows[DockState.DockBottom] });
        ...
        {
            if ((this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.SystemMdi) || (this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.DockingMdi))
            {
                return ((base.Parent == null) ? Rectangle.Empty : base.Parent.RectangleToClient(base.RectangleToScreen(rectAutoHideWindow)));
            }
        ...
        private void InitUpZOrderMap()
        {
            this.m_UpZOrderMap.Add(DockStyle.Left, new UpZOrderHandler(this.UpLeftZOrder));
            this.m_UpZOrderMap.Add(DockStyle.Right, new UpZOrderHandler(this.UpRightZOrder));
            this.m_UpZOrderMap.Add(DockStyle.Top, new UpZOrderHandler(this.UpTopZOrder));
            this.m_UpZOrderMap.Add(DockStyle.Bottom, new UpZOrderHandler(this.UpBottomZOrder));
            this.m_UpZOrderMap.Add(DockStyle.Fill, new UpZOrderHandler(this.UpFillZorder));
        }
        ...
        {
            if ((this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.DockingSdi) || (this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.DockingWindow))
            {
                return true;
            }
        ...
        {
            if (this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.DockingMdi)
            {
        ...
        {
            EventHandler<DockContentEventArgs> handler = (EventHandler<DockContentEventArgs>) base.Events[ContentAddedEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            EventHandler<DockContentEventArgs> handler = (EventHandler<DockContentEventArgs>) base.Events[ContentRemovedEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        protected virtual void OnContentRemoving(DockContentEventArgs e, FormClosingEventArgs a)
        {
            ContentClosingEventHandler handler = (ContentClosingEventHandler) base.Events[ContentRemovingEvent];
            if (handler != null)
            {
                handler(this, e, a);
            }
        ...
        protected override void OnLayout(LayoutEventArgs levent)
        {
            ...
            if ((this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.SystemMdi) && this.MdiClientExists)
            {
                this.SetMdiClientBounds(this.SystemMdiClientBounds);
                this.InvalidateWindowRegion();
            }
            else if (this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.DockingMdi)
            {
                this.InvalidateWindowRegion();
            }
        ...
        private void ParentFormMdiChildActivate(object sender, EventArgs e)
        {
            if (this.GetMdiClientController().ParentForm != null)
            {
                ...
                if ((activeMdiChild != null) && ((activeMdiChild.DockHandler.DockPanel == this) && (activeMdiChild.DockHandler.Pane != null)))
                {
        ...
        internal void RemovingContent(IDockContent content, FormClosingEventArgs e)
        {
            if (content == null)
            {
                throw new ArgumentNullException();
            ...
            if (this.Contents.Contains(content))
            {
                this.OnContentRemoving(new DockContentEventArgs(content), e);
            }
        }
        ...
        {
            Control parent;
            if ((this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.DockingMdi) || (this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.SystemMdi))
            {
                parent = base.Parent;
            }
            else
        ...
        private void SetMdiClient()
        {
            ...
            else if ((this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.DockingSdi) || (this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.DockingWindow))
            {
            ...
            else if (this.DocumentStyle == UPlan.Frame.DockForm.DocumentStyle.SystemMdi)
            {
                mdiClientController.AutoScroll = true;
                mdiClientController.BorderStyle = BorderStyle.Fixed3D;
        ...
        private void UpBottomZOrder(bool fullPanelEdge)
        {
            if (fullPanelEdge)
            {
        ...
        {
            this.m_UpZOrderMap[dockStyle](fullPanelEdge);
        }
        ...
        private void UpFillZorder(bool fullPanelEdge)
        {
            if (fullPanelEdge)
            {
                this.DockWindows[DockState.Document].SendToBack();
            }
            else
            {
                this.DockWindows[DockState.Document].BringToFront();
        ...
        private void UpLeftZOrder(bool fullPanelEdge)
        {
            if (fullPanelEdge)
            {
        ...
        private void UpRightZOrder(bool fullPanelEdge)
        {
            if (fullPanelEdge)
            {
        ...
        private void UpTopZOrder(bool fullPanelEdge)
        {
            if (fullPanelEdge)
            {
        ...
        [DefaultValue(true), LocalizedDescription("DockPanel_AllowEndUserNestedDocking_Description"), LocalizedCategory("Category_Docking")]
        ...
        [Browsable(false)]
        public IDockContent ContentActivating
        {
            get
            {
                return this.FocusManager.ContentActivating;
            }
            set
            {
                this.FocusManager.ContentActivating = value;
            }
        }
        ...
        internal Rectangle DockArea
        {
            get
            {
                return new Rectangle(base.DockPadding.Left, base.DockPadding.Top, (base.ClientRectangle.Width - base.DockPadding.Left) - base.DockPadding.Right, (base.ClientRectangle.Height - base.DockPadding.Top) - base.DockPadding.Bottom);
            }
        }

        [DefaultValue((double) 0.25), LocalizedCategory("Category_Docking"), LocalizedDescription("DockPanel_DockBottomPortion_Description")]
        public double DockBottomPortion
        {
            ...
            set
            {
                ...
                if (value != this.m_dockBottomPortion)
                {
                    ...
                    if (((this.m_dockBottomPortion < 1.0) && (this.m_dockTopPortion < 1.0)) && ((this.m_dockTopPortion + this.m_dockBottomPortion) > 1.0))
                    {
        ...
        [DefaultValue((double) 0.25), LocalizedDescription("DockPanel_DockLeftPortion_Description"), LocalizedCategory("Category_Docking")]
        public double DockLeftPortion
        {
            ...
            set
            {
                ...
                if (value != this.m_dockLeftPortion)
                {
                    ...
                    if (((this.m_dockLeftPortion < 1.0) && (this.m_dockRightPortion < 1.0)) && ((this.m_dockLeftPortion + this.m_dockRightPortion) > 1.0))
                    {
        ...
        [LocalizedCategory("Category_Docking"), LocalizedDescription("DockPanel_DockRightPortion_Description"), DefaultValue((double) 0.25)]
        ...
        [DefaultValue((double) 0.25), LocalizedDescription("DockPanel_DockTopPortion_Description"), LocalizedCategory("Category_Docking")]
        public double DockTopPortion
        {
            ...
            set
            {
                ...
                if (value != this.m_dockTopPortion)
                {
                    ...
                    if (((this.m_dockTopPortion < 1.0) && (this.m_dockBottomPortion < 1.0)) && ((this.m_dockTopPortion + this.m_dockBottomPortion) > 1.0))
                    {
        ...
        [LocalizedCategory("Category_Docking"), LocalizedDescription("DockPanel_DocumentStyle_Description"), DefaultValue(0)]
        public UPlan.Frame.DockForm.DocumentStyle DocumentStyle
        {
            get
            {
            ...
            set
            {
                ...
                {
                    if (!Enum.IsDefined(typeof(UPlan.Frame.DockForm.DocumentStyle), value))
                    {
                        throw new InvalidEnumArgumentException();
                    }
                    if ((value == UPlan.Frame.DockForm.DocumentStyle.SystemMdi) && (this.DockWindows[DockState.Document].VisibleNestedPanes.Count > 0))
                    {
                        throw new InvalidEnumArgumentException();
                    }
        ...
        [DefaultValue(false), LocalizedDescription("DockPanel_RightToLeftLayout_Description"), LocalizedCategory("Appearance")]
        ...
        [LocalizedDescription("DockPanel_ShowDocumentIcon_Description"), DefaultValue(false), LocalizedCategory("Category_Docking")]
        ...
        private class AutoHideWindowControl : Panel, ISplitterDragSource, IDragSource
        {
            ...
            private UPlan.Frame.DockForm.DockPanel m_dockPanel = null;
            ...
            public AutoHideWindowControl(UPlan.Frame.DockForm.DockPanel dockPanel)
            {
            ...
            private void AnimateWindow(bool show)
            {
                ...
                else
                {
                    ...
                    if (this.DockState == UPlan.Frame.DockForm.DockState.DockTopAutoHide)
                    {
                        num4 = show ? 1 : -1;
                    }
                    else if (this.DockState == UPlan.Frame.DockForm.DockState.DockLeftAutoHide)
                    {
                        num3 = show ? 1 : -1;
                    }
                    else if (this.DockState == UPlan.Frame.DockForm.DockState.DockRightAutoHide)
                    {
                        num = show ? -1 : 1;
                        num3 = show ? 1 : -1;
                    }
                    else if (this.DockState == UPlan.Frame.DockForm.DockState.DockBottomAutoHide)
                    {
                        num2 = show ? -1 : 1;
                        num4 = show ? 1 : -1;
                    }
                    if (show)
                    {
                        base.Bounds = this.DockPanel.GetAutoHideWindowBounds(new Rectangle(-rectangle.Width, -rectangle.Height, rectangle.Width, rectangle.Height));
                        if (!base.Visible)
                        {
                            base.Visible = true;
                        }
                    ...
                    int num5 = 1;
                    int num7 = (rect.Width != rectangle.Width) ? Math.Abs((int) (rect.Width - rectangle.Width)) : Math.Abs((int) (rect.Height - rectangle.Height));
            ...
            {
                if (this.DockState == UPlan.Frame.DockForm.DockState.Unknown)
                {
                    return Rectangle.Empty;
                }
                ...
                if (!show)
                {
                    if (this.DockState == UPlan.Frame.DockForm.DockState.DockLeftAutoHide)
                    {
                        autoHideWindowRectangle.Width = 0;
                    }
                    else
                    {
                        if (this.DockState == UPlan.Frame.DockForm.DockState.DockRightAutoHide)
                        {
            ...
            void ISplitterDragSource.MoveSplitter(int offset)
            {
                ...
                if ((this.DockState == UPlan.Frame.DockForm.DockState.DockLeftAutoHide) && (dockArea.Width > 0))
                {
                ...
                else if ((this.DockState == UPlan.Frame.DockForm.DockState.DockRightAutoHide) && (dockArea.Width > 0))
                {
                    if (activeContent.DockHandler.AutoHidePortion < 1.0)
                    {
                ...
                else if ((this.DockState == UPlan.Frame.DockForm.DockState.DockBottomAutoHide) && (dockArea.Height > 0))
                {
                    if (activeContent.DockHandler.AutoHidePortion < 1.0)
                    {
                ...
                else if ((this.DockState == UPlan.Frame.DockForm.DockState.DockTopAutoHide) && (dockArea.Height > 0))
                {
                    if (activeContent.DockHandler.AutoHidePortion < 1.0)
                    {
            ...
            private void LayoutAnimateWindow(Rectangle rect)
            {
                ...
                else if (this.DockState == UPlan.Frame.DockForm.DockState.DockTopAutoHide)
                {
            ...
            protected override void OnLayout(LayoutEventArgs levent)
            {
                ...
                Rectangle rectangle2 = new Rectangle(-displayingRectangle.Width, displayingRectangle.Y, displayingRectangle.Width, displayingRectangle.Height);
            ...
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                if (this.DockState == UPlan.Frame.DockForm.DockState.DockBottomAutoHide)
                {
            ...
            {
                if ((this.ActiveContent != null) && !DockHelper.IsDockStateAutoHide(this.ActiveContent.DockHandler.DockState))
                {
            ...
            public IDockContent ActiveContent
            {
                ...
                set
                {
                    ...
                    {
                        if ((value != null) && !(DockHelper.IsDockStateAutoHide(value.DockHandler.DockState) && (value.DockHandler.DockPanel == this.DockPanel)))
                        {
            ...
            public UPlan.Frame.DockForm.DockState DockState
            {
                get
                {
                    return ((this.ActiveContent == null) ? UPlan.Frame.DockForm.DockState.Unknown : this.ActiveContent.DockHandler.DockState);
                }
            }
            ...
            bool ISplitterDragSource.IsVertical
            {
                get
                {
                    return ((this.DockState == UPlan.Frame.DockForm.DockState.DockLeftAutoHide) || (this.DockState == UPlan.Frame.DockForm.DockState.DockRightAutoHide));
                }
            }
        ...
        public delegate void ContentClosingEventHandler(object sender, DockContentEventArgs content, FormClosingEventArgs e);
        ...
        private sealed class DockDragHandler : DockPanel.DragHandler
        {
            ...
            private void DockPaneTestDrop()
            {
                if ((Control.ModifierKeys & Keys.Control) == Keys.None)
                {
                    this.Indicator.TestDrop();
                    this.PaneTestDrop();
                    this.FloatWindowTestDrop();
                }
                else
                {
            ...
            private void FloatWindowTestDrop()
            {
                if ((!this.Outline.FlagTestDrop && (this.DragSource != null)) && this.DragSource.IsDockStateValid(DockState.Float))
                {
            ...
            protected override void OnEndDrag(bool abort)
            {
                ...
                this.EndDrag(abort);
                base.DockPanel.ContentActivating = null;
                base.DockPanel.ResumeLayout(true, true);
                if ("DockContentHandler".Equals(this.DragSource.GetType().Name))
                {
                    DockContentHandler dragSource = this.DragSource as DockContentHandler;
                    DockContent form = dragSource.Form as DockContent;
                    form.LDClickTimes++;
                }
                this.DragSource = null;
            }

            private void OutLineTestDrop()
            {
                if (!this.Outline.FlagTestDrop && ((this.DragSource != null) && this.DragSource.IsDockStateValid(DockState.Float)))
                {
            ...
            private void PaneTestDrop()
            {
                if (!this.Outline.FlagTestDrop)
                {
                    DockPane pane = DockHelper.PaneAtPoint(Control.MousePosition, base.DockPanel);
                    if (((pane != null) && (this.DragSource != null)) && this.DragSource.IsDockStateValid(pane.DockState))
                    {
            ...
            private void TestDrop()
            {
                ...
                this.DockPaneTestDrop();
                this.OutLineTestDrop();
                this.SetCursorCuttent();
            }
            ...
            private class DockIndicator : DragForm
            {
                ...
                private UPlan.Frame.DockForm.DockPanel.DockDragHandler m_dragHandler;
                ...
                public DockIndicator(UPlan.Frame.DockForm.DockPanel.DockDragHandler dragHandler)
                {
                    this.m_dragHandler = dragHandler;
                    base.Controls.AddRange(new Control[] { this.PaneDiamond, this.PanelLeft, this.PanelRight, this.PanelTop, this.PanelBottom, this.PanelFill });
                    base.Region = new Region(Rectangle.Empty);
                }

                private Point GetHitTestResult(Point pt)
                {
                    ...
                    if (TestDrop(this.PanelRight, pt) != DockStyle.None)
                    {
                        this.HitTestResult = this.PanelRight;
                        return pt;
                    }
                    if (TestDrop(this.PanelTop, pt) != DockStyle.None)
                    {
                        this.HitTestResult = this.PanelTop;
                        return pt;
                    }
                    if (TestDrop(this.PanelBottom, pt) != DockStyle.None)
                    {
                        this.HitTestResult = this.PanelBottom;
                        return pt;
                    }
                    if (TestDrop(this.PanelFill, pt) != DockStyle.None)
                    {
                        this.HitTestResult = this.PanelFill;
                        return pt;
                    }
                    if (TestDrop(this.PaneDiamond, pt) != DockStyle.None)
                    {
                ...
                private void GetRegion(Region region)
                {
                    ...
                    {
                        Rectangle rectangle = base.RectangleToClient(this.DockPane.RectangleToScreen(this.DockPane.ClientRectangle));
                        this.PaneDiamond.Location = new Point(rectangle.Left + ((rectangle.Width - this.PaneDiamond.Width) / 2), rectangle.Top + ((rectangle.Height - this.PaneDiamond.Height) / 2));
                        this.PaneDiamond.Visible = true;
                        using (GraphicsPath path = PaneIndicator.DisplayingGraphicsPath.Clone() as GraphicsPath)
                        {
                            Point[] plgpts = new Point[] { new Point(this.PaneDiamond.Left, this.PaneDiamond.Top), new Point(this.PaneDiamond.Right, this.PaneDiamond.Top), new Point(this.PaneDiamond.Left, this.PaneDiamond.Bottom) };
                ...
                private Rectangle ProcessPanelBottom(Region region, Rectangle rectDockArea)
                {
                ...
                private void ProcessPanelFill(Region region)
                {
                ...
                private Rectangle ProcessPanelLeft(Region region, Rectangle rectDockArea)
                {
                ...
                private Rectangle ProcessPanelRight(Region region, Rectangle rectDockArea)
                {
                ...
                private Rectangle ProcessPanelTop(Region region, Rectangle rectDockArea)
                {
                ...
                private void RefreshChanges()
                {
                    ...
                    r = this.ProcessPanelLeft(region, r);
                    r = this.ProcessPanelRight(region, r);
                    r = this.ProcessPanelTop(region, r);
                    r = this.ProcessPanelBottom(region, r);
                    this.ProcessPanelFill(region);
                ...
                {
                    if ((this.DockPane == null) || (this.DragHandler.DragSource == null))
                    {
                        return false;
                    }
                ...
                public void TestDrop()
                {
                    ...
                    mousePosition = this.GetHitTestResult(mousePosition);
                ...
                private UPlan.Frame.DockForm.DockPane DisplayingPane
                {
                    get
                    {
                ...
                public UPlan.Frame.DockForm.DockPane DockPane
                {
                    ...
                    internal set
                    {
                        ...
                        {
                            UPlan.Frame.DockForm.DockPane displayingPane = this.DisplayingPane;
                ...
                public UPlan.Frame.DockForm.DockPanel.DockDragHandler DragHandler
                {
                    get
                    {
                ...
                private class PaneIndicator : PictureBox, DockPanel.DockDragHandler.DockIndicator.IHitTest
                {
                    ...
                    private static HotSpotIndex[] _hotSpots = new HotSpotIndex[] { new HotSpotIndex(1, 0, DockStyle.Top), new HotSpotIndex(0, 1, DockStyle.Left), new HotSpotIndex(1, 1, DockStyle.Fill), new HotSpotIndex(2, 1, DockStyle.Right), new HotSpotIndex(1, 2, DockStyle.Bottom) };
                ...
                private class PanelIndicator : PictureBox, DockPanel.DockDragHandler.DockIndicator.IHitTest
                {
                    ...
                    {
                        return ((base.Visible && base.ClientRectangle.Contains(base.PointToClient(pt))) ? this.DockStyle : System.Windows.Forms.DockStyle.None);
                    }
            ...
            {
                private UPlan.Frame.DockForm.DragForm m_dragForm = new UPlan.Frame.DockForm.DragForm();
                ...
                private void SetOutline(DockPane pane, DockStyle dock, int contentIndex)
                {
                    ...
                    else
                    {
                        using (GraphicsPath path = pane.TabStripControl.GetOutline(contentIndex))
                        {
                            ...
                            displayingRectangle = new Rectangle((int) bounds.X, (int) bounds.Y, (int) bounds.Width, (int) bounds.Height);
                            Point[] plgpts = new Point[] { new Point(0, 0), new Point(displayingRectangle.Width, 0), new Point(0, displayingRectangle.Height) };
                ...
                private UPlan.Frame.DockForm.DragForm DragForm
                {
                    get
                    {
        ...
        private abstract class DragHandler : UPlan.Frame.DockForm.DockPanel.DragHandlerBase
        {
            private UPlan.Frame.DockForm.DockPanel m_dockPanel;
            private IDragSource m_dragSource;

            protected DragHandler(UPlan.Frame.DockForm.DockPanel dockPanel)
            {
                this.m_dockPanel = dockPanel;
            }
        ...
        private abstract class DragHandlerBase : NativeWindow, IMessageFilter
        {
            ...
            protected bool BeginDrag()
            {
                lock (this)
                {
                    ...
                    if (!UPlan.Frame.DockForm.NativeMethods.DragDetect(this.DragControl.Handle, this.StartMousePosition))
                    {
                        return false;
                    }
        ...
        private class FocusManagerImpl : Component, IContentFocusManager, UPlan.Frame.DockForm.DockPanel.IFocusManager
        {
            private IDockContent m_activeContent = null;
            ...
            private bool m_disposed = false;
            private UPlan.Frame.DockForm.DockPanel m_dockPanel;
            private UPlan.Frame.DockForm.DockPanel.FocusManagerImpl.LocalWindowsHook.HookEventHandler m_hookEventHandler;
            ...
            public FocusManagerImpl(UPlan.Frame.DockForm.DockPanel dockPanel)
            {
                this.m_dockPanel = dockPanel;
                this.m_localWindowsHook = new LocalWindowsHook(HookType.WH_CALLWNDPROCRET);
                this.m_hookEventHandler = new UPlan.Frame.DockForm.DockPanel.FocusManagerImpl.LocalWindowsHook.HookEventHandler(this.HookEventHandler);
            ...
            public void Activate(IDockContent content)
            {
                ...
                else if (content != null)
                {
                    ...
                    if (!dockHandler.Form.IsDisposed)
                    {
                        ...
                        {
                            UPlan.Frame.DockForm.NativeMethods.SetFocus(dockHandler.ActiveWindowHandle);
                        }
                        if (!dockHandler.Form.ContainsFocus && !dockHandler.Form.SelectNextControl(dockHandler.Form.ActiveControl, true, true, true, true))
                        {
                            UPlan.Frame.DockForm.NativeMethods.SetFocus(dockHandler.Form.Handle);
                        }
                    }
                }
            }
            ...
            private DockPane GetActivedDockPane(DockPane value)
            {
            ...
            {
                DockPane activedDockPane = null;
                if ((this.ActivePane != null) && (this.ActivePane.DockState == DockState.Document))
                {
                    activedDockPane = this.ActivePane;
                }
                activedDockPane = this.GetActivedDockPane(activedDockPane);
                if (this.m_activeDocumentPane != activedDockPane)
                {
                    if (this.m_activeDocumentPane != null)
                    {
                        this.m_activeDocumentPane.SetIsActiveDocumentPane(false);
                    }
                    this.m_activeDocumentPane = activedDockPane;
                    if (this.m_activeDocumentPane != null)
                    {
            ...
            private void SetActivePane()
            {
                DockPane paneFromHandle = this.GetPaneFromHandle(UPlan.Frame.DockForm.NativeMethods.GetFocus());
                if (null == paneFromHandle)
                {
                    paneFromHandle = this.ActiveDocumentPane;
                }
            ...
            public List<IDockContent> ListContent
            {
                get
                {
            ...
            {
                private UPlan.Frame.DockForm.NativeMethods.HookProc m_filterFunc = null;
                ...
                public LocalWindowsHook(HookType hook)
                {
                    ...
                    this.m_filterFunc = new UPlan.Frame.DockForm.NativeMethods.HookProc(this.CoreHookProc);
                }
                ...
                public IntPtr CoreHookProc(int code, IntPtr wParam, IntPtr lParam)
                {
                    ...
                    return UPlan.Frame.DockForm.NativeMethods.CallNextHookEx(this.m_hHook, code, wParam, lParam);
                }
                ...
                public void Install()
                {
                    ...
                    int currentThreadId = UPlan.Frame.DockForm.NativeMethods.GetCurrentThreadId();
                    this.m_hHook = UPlan.Frame.DockForm.NativeMethods.SetWindowsHookEx(this.m_hookType, this.m_filterFunc, IntPtr.Zero, currentThreadId);
                }
                ...
                public void Uninstall()
                {
                    if (this.m_hHook != IntPtr.Zero)
                    {
                        UPlan.Frame.DockForm.NativeMethods.UnhookWindowsHookEx(this.m_hHook);
        ...
        private interface IFocusManager
        {
            ...
            IDockContent ContentActivating { get; set; }
        ...
        private class MdiClientController : NativeWindow, IComponent, IDisposable
        {
            ...
            {
                UPlan.Frame.DockForm.NativeMethods.SetWindowPos(this.MdiClient.Handle, IntPtr.Zero, 0, 0, 0, 0, FlagsSetWindowPos.SWP_DRAWFRAME | FlagsSetWindowPos.SWP_NOACTIVATE | FlagsSetWindowPos.SWP_NOMOVE | FlagsSetWindowPos.SWP_NOOWNERZORDER | FlagsSetWindowPos.SWP_NOSIZE | FlagsSetWindowPos.SWP_NOZORDER);
            }
            ...
            protected override void WndProc(ref Message m)
            {
                ...
                {
                    UPlan.Frame.DockForm.NativeMethods.ShowScrollBar(m.HWnd, 3, 0);
                }
                base.WndProc(ref m);
            }
            ...
            public System.Windows.Forms.BorderStyle BorderStyle
            {
                set
                {
                    ...
                    {
                        int windowLong = UPlan.Frame.DockForm.NativeMethods.GetWindowLong(this.MdiClient.Handle, -16);
                        int num2 = UPlan.Frame.DockForm.NativeMethods.GetWindowLong(this.MdiClient.Handle, -20);
                        ...
                        UPlan.Frame.DockForm.NativeMethods.SetWindowLong(this.MdiClient.Handle, -16, windowLong);
                        UPlan.Frame.DockForm.NativeMethods.SetWindowLong(this.MdiClient.Handle, -20, num2);
                        this.UpdateStyles();
                    }
                }
            }
        ...
        private static class Persistor
        {
            ...
            private static void AssignPanesToWindows(DockPanel dockPanel, PaneStruct[] panes, DockWindowStruct[] dockWindows)
            {
                for (int i = 0; i < dockWindows.Length; i++)
                {
                    for (int j = 0; j < dockWindows[i].NestedPanes.Length; j++)
                    {
                        DockWindow container = dockPanel.DockWindows[dockWindows[i].DockState];
                        ...
                        DockPane previousPane = (indexPrevPane == -1) ? container.NestedPanes.GetDefaultPreviousPane(pane) : dockPanel.Panes[indexPrevPane];
                        ...
                        if (panes[indexPane].DockState == container.DockState)
                        {
            ...
            private static void CreateContents(DockPanel dockPanel, DeserializeDockContent deserializeContent, ContentStruct[] contents)
            {
            ...
            private static void CreateFloatWindows(DockPanel dockPanel, PaneStruct[] panes, FloatWindowStruct[] floatWindows)
            {
                for (int i = 0; i < floatWindows.Length; i++)
                {
                    FloatWindow container = null;
                    for (int j = 0; j < floatWindows[i].NestedPanes.Length; j++)
                    {
                        ...
                        if (j == 0)
                        {
                            container = dockPanel.FloatWindowFactory.CreateFloatWindow(dockPanel, pane, floatWindows[i].Bounds);
                        }
                        else
                        {
            ...
            private static void CreatePanes(DockPanel dockPanel, PaneStruct[] panes)
            {
            ...
            private static ContentStruct[] LoadContents(XmlTextReader xmlIn)
            {
                ...
                for (int i = 0; i < num; i++)
                {
                    ...
                    structArray[i].AutoHidePortion = Convert.ToDouble(xmlIn.GetAttribute("AutoHidePortion"), CultureInfo.InvariantCulture);
                    structArray[i].IsHidden = Convert.ToBoolean(xmlIn.GetAttribute("IsHidden"), CultureInfo.InvariantCulture);
                    structArray[i].IsFloat = Convert.ToBoolean(xmlIn.GetAttribute("IsFloat"), CultureInfo.InvariantCulture);
                    MoveToNextElement(xmlIn);
                }
                return structArray;
            }
            ...
            private static DockWindowStruct[] LoadDockWindows(XmlTextReader xmlIn, DockPanel dockPanel)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    structArray[i].ZOrderIndex = Convert.ToInt32(xmlIn.GetAttribute("ZOrderIndex"), CultureInfo.InvariantCulture);
                    MoveToNextElement(xmlIn);
                    ...
                    for (int j = 0; j < num4; j++)
                    {
                        ...
                        structArray[i].NestedPanes[j].IndexPane = Convert.ToInt32(xmlIn.GetAttribute("RefID"), CultureInfo.InvariantCulture);
                        structArray[i].NestedPanes[j].IndexPrevPane = Convert.ToInt32(xmlIn.GetAttribute("PrevPane"), CultureInfo.InvariantCulture);
                        structArray[i].NestedPanes[j].Alignment = (DockAlignment) converter2.ConvertFrom(xmlIn.GetAttribute("Alignment"));
                        structArray[i].NestedPanes[j].Proportion = Convert.ToDouble(xmlIn.GetAttribute("Proportion"), CultureInfo.InvariantCulture);
                        MoveToNextElement(xmlIn);
                    }
                }
                return structArray;
            ...
            private static FloatWindowStruct[] LoadFloatWindows(XmlTextReader xmlIn)
            {
                ...
                for (int i = 0; i < num; i++)
                {
                    ...
                    structArray[i].Bounds = (Rectangle) converter2.ConvertFromInvariantString(xmlIn.GetAttribute("Bounds"));
                    structArray[i].ZOrderIndex = Convert.ToInt32(xmlIn.GetAttribute("ZOrderIndex"), CultureInfo.InvariantCulture);
                    MoveToNextElement(xmlIn);
                    if ((xmlIn.Name != "DockList") && (xmlIn.Name != "NestedPanes"))
                    {
                    ...
                    for (int j = 0; j < num4; j++)
                    {
                        ...
                        structArray[i].NestedPanes[j].IndexPane = Convert.ToInt32(xmlIn.GetAttribute("RefID"), CultureInfo.InvariantCulture);
                        structArray[i].NestedPanes[j].IndexPrevPane = Convert.ToInt32(xmlIn.GetAttribute("PrevPane"), CultureInfo.InvariantCulture);
                        structArray[i].NestedPanes[j].Alignment = (DockAlignment) converter.ConvertFrom(xmlIn.GetAttribute("Alignment"));
                        structArray[i].NestedPanes[j].Proportion = Convert.ToDouble(xmlIn.GetAttribute("Proportion"), CultureInfo.InvariantCulture);
                        MoveToNextElement(xmlIn);
                    }
                }
            ...
            {
                ContentStruct[] structArray;
                PaneStruct[] structArray2;
                DockWindowStruct[] structArray3;
                FloatWindowStruct[] structArray4;
                ...
                dockPanelStruct = SetDockPanelAttrib(xmlIn, dockPanelStruct);
                LoadInfoFromXml(dockPanel, xmlIn, out structArray, out structArray2, out structArray3, out structArray4);
                if (closeStream)
                {
                    xmlIn.Close();
                }
                ...
                SetWindowZOrders(dockPanel, structArray3);
                CreateContents(dockPanel, deserializeContent, structArray);
                CreatePanes(dockPanel, structArray2);
                AssignPanesToWindows(dockPanel, structArray2, structArray3);
                CreateFloatWindows(dockPanel, structArray2, structArray4);
                int[] sortedContents = SortDockContent(dockPanel, structArray, structArray2);
                ShowNonDocumentFirst(dockPanel, structArray, sortedContents);
                dockPanelStruct = ShowDocument(dockPanel, dockPanelStruct, structArray, structArray2, sortedContents);
                dockPanel.ResumeLayout(true, true);
            }

            private static void LoadInfoFromXml(DockPanel dockPanel, XmlTextReader xmlIn, out ContentStruct[] contents, out PaneStruct[] panes, out DockWindowStruct[] dockWindows, out FloatWindowStruct[] floatWindows)
            {
                MoveToNextElement(xmlIn);
            ...
            private static PaneStruct[] LoadPanes(XmlTextReader xmlIn)
            {
                ...
                for (int i = 0; i < num; i++)
                {
                    ...
                    structArray[i].DockState = (DockState) converter.ConvertFrom(xmlIn.GetAttribute("DockState"));
                    structArray[i].IndexActiveContent = Convert.ToInt32(xmlIn.GetAttribute("ActiveContent"), CultureInfo.InvariantCulture);
                    ...
                    for (int j = 0; j < num4; j++)
                    {
                        ...
                        structArray[i].IndexContents[j] = Convert.ToInt32(xmlIn.GetAttribute("RefID"), CultureInfo.InvariantCulture);
                        MoveToNextElement(xmlIn);
                    }
                }
                return structArray;
            ...
            public static void SaveAsXml(DockPanel dockPanel, Stream stream, Encoding encoding, bool upstream)
            {
                ...
                WritePanelToXml(dockPanel, xmlOut);
                if (!upstream)
                {
            ...
            private static DockPanelStruct SetDockPanelAttrib(XmlTextReader xmlIn, DockPanelStruct dockPanelStruct)
            {
            ...
            private static void SetWindowZOrders(DockPanel dockPanel, DockWindowStruct[] dockWindows)
            {
                int num = 0x7fffffff;
                for (int i = 0; i < dockWindows.Length; i++)
                {
                    ...
                    {
                        if ((dockWindows[j].ZOrderIndex > zOrderIndex) && (dockWindows[j].ZOrderIndex < num))
                        {
                            zOrderIndex = dockWindows[j].ZOrderIndex;
                            index = j;
                        }
                    }
            ...
            private static DockPanelStruct ShowDocument(DockPanel dockPanel, DockPanelStruct dockPanelStruct, ContentStruct[] contents, PaneStruct[] panes, int[] sortedContents)
            {
                int num;
                for (num = 0; num < contents.Length; num++)
                {
                    IDockContent content = dockPanel.Contents[sortedContents[num]];
                    if ((content.DockHandler.Pane != null) && (content.DockHandler.Pane.DockState == DockState.Document))
                    {
                        content.DockHandler.IsHidden = contents[sortedContents[num]].IsHidden;
                    }
                }
                for (num = 0; num < panes.Length; num++)
                {
                    dockPanel.Panes[num].ActiveContent = (panes[num].IndexActiveContent == -1) ? null : dockPanel.Contents[panes[num].IndexActiveContent];
                }
                ...
                for (num = dockPanel.Contents.Count - 1; num >= 0; num--)
                {
                    if (dockPanel.Contents[num] is DummyContent)
                    {
                        dockPanel.Contents[num].DockHandler.Form.Close();
                    }
                }
                return dockPanelStruct;
            }

            private static void ShowNonDocumentFirst(DockPanel dockPanel, ContentStruct[] contents, int[] sortedContents)
            {
                for (int i = 0; i < contents.Length; i++)
                {
            ...
            private static int[] SortDockContent(DockPanel dockPanel, ContentStruct[] contents, PaneStruct[] panes)
            {
                int[] numArray = null;
                if (contents.Length > 0)
                {
                    int num;
                    numArray = new int[contents.Length];
                    for (num = 0; num < contents.Length; num++)
                    {
                        numArray[num] = num;
                    }
                    int length = contents.Length;
                    for (num = 0; num < (contents.Length - 1); num++)
                    {
                        for (int i = num + 1; i < contents.Length; i++)
                        {
                            DockPane pane = dockPanel.Contents[numArray[num]].DockHandler.Pane;
                            int num4 = (pane == null) ? 0 : panes[dockPanel.Panes.IndexOf(pane)].ZOrderIndex;
                            DockPane pane2 = dockPanel.Contents[numArray[i]].DockHandler.Pane;
                            int num5 = (pane2 == null) ? 0 : panes[dockPanel.Panes.IndexOf(pane2)].ZOrderIndex;
                            if (num4 > num5)
                            {
                                int num6 = numArray[num];
                                numArray[num] = numArray[i];
                                numArray[i] = num6;
                            }
                        }
                    }
            ...
            private static void WriteContentsToXml(DockPanel dockPanel, XmlTextWriter xmlOut)
            {
            ...
            private static void WriteDockWindowsToXml(DockPanel dockPanel, XmlTextWriter xmlOut)
            {
                ...
                foreach (DockWindow window in dockPanel.DockWindows)
                {
                    ...
                    xmlOut.WriteAttributeString("ID", num.ToString(CultureInfo.InvariantCulture));
                    num++;
                    xmlOut.WriteAttributeString("DockState", window.DockState.ToString());
                    xmlOut.WriteAttributeString("ZOrderIndex", dockPanel.Controls.IndexOf(window).ToString(CultureInfo.InvariantCulture));
                    xmlOut.WriteStartElement("NestedPanes");
                    xmlOut.WriteAttributeString("Count", window.NestedPanes.Count.ToString(CultureInfo.InvariantCulture));
                    foreach (DockPane pane in window.NestedPanes)
                    {
                        xmlOut.WriteStartElement("Pane");
                        xmlOut.WriteAttributeString("ID", window.NestedPanes.IndexOf(pane).ToString(CultureInfo.InvariantCulture));
                        ...
                        xmlOut.WriteAttributeString("PrevPane", dockPanel.Panes.IndexOf(nestedDockingStatus.PreviousPane).ToString(CultureInfo.InvariantCulture));
                        xmlOut.WriteAttributeString("Alignment", nestedDockingStatus.Alignment.ToString());
                        xmlOut.WriteAttributeString("Proportion", nestedDockingStatus.Proportion.ToString(CultureInfo.InvariantCulture));
                        xmlOut.WriteEndElement();
                    }
                    xmlOut.WriteEndElement();
                    xmlOut.WriteEndElement();
            ...
            private static void WriteFloatWindowsToXml(DockPanel dockPanel, XmlTextWriter xmlOut)
            {
                ...
                foreach (FloatWindow window in dockPanel.FloatWindows)
                {
                    ...
                    xmlOut.WriteAttributeString("ID", dockPanel.FloatWindows.IndexOf(window).ToString(CultureInfo.InvariantCulture));
                    xmlOut.WriteAttributeString("Bounds", converter.ConvertToInvariantString(window.Bounds));
                    xmlOut.WriteAttributeString("ZOrderIndex", window.DockPanel.FloatWindows.IndexOf(window).ToString(CultureInfo.InvariantCulture));
                    xmlOut.WriteStartElement("NestedPanes");
                    xmlOut.WriteAttributeString("Count", window.NestedPanes.Count.ToString(CultureInfo.InvariantCulture));
                    foreach (DockPane pane in window.NestedPanes)
                    {
            ...
            private static void WritePanelAttribToXml(DockPanel dockPanel, XmlTextWriter xmlOut)
            {
                xmlOut.WriteAttributeString("FormatVersion", "1.0");
            ...
            private static void WritePanelToXml(DockPanel dockPanel, XmlTextWriter xmlOut)
            {
                xmlOut.WriteStartElement("DockPanel");
                WritePanelAttribToXml(dockPanel, xmlOut);
                WriteContentsToXml(dockPanel, xmlOut);
                WritePanesToXml(dockPanel, xmlOut);
                WriteDockWindowsToXml(dockPanel, xmlOut);
                WriteFloatWindowsToXml(dockPanel, xmlOut);
                xmlOut.WriteEndElement();
            }

            private static void WritePanesToXml(DockPanel dockPanel, XmlTextWriter xmlOut)
            {
        ...
        private delegate void UpZOrderHandler(bool fullPanelEdge);
    }
}
