namespace UPlan.Frame.DockForm
{
    ...
    public class DockPane : UserControl, IDockDragSource, IDragSource
    {
        ...
        private UPlan.Frame.DockForm.NestedDockingStatus m_nestedDockingStatus;
        ...
        protected internal DockPane(IDockContent content, UPlan.Frame.DockForm.DockState visibleState, bool show)
        {
            ...
            this.m_dockState = UPlan.Frame.DockForm.DockState.Unknown;
        ...
        protected internal DockPane(IDockContent content, UPlan.Frame.DockForm.FloatWindow floatWindow, bool show)
        {
            this.m_activeContent = null;
            this.m_allowDockDragAndDrop = true;
            this.m_autoHidePane = null;
            ...
            this.InternalConstruct(content, UPlan.Frame.DockForm.DockState.Float, false, Rectangle.Empty, floatWindow.NestedPanes.GetDefaultPreviousPane(this), DockAlignment.Right, 0.5, show);
        }
        ...
        protected internal DockPane(IDockContent content, Rectangle floatWindowBounds, bool show)
        {
            ...
            this.m_dockState = UPlan.Frame.DockForm.DockState.Unknown;
            this.m_countRefreshStateChange = 0;
            this.InternalConstruct(content, UPlan.Frame.DockForm.DockState.Float, true, floatWindowBounds, null, DockAlignment.Right, 0.5, show);
        }
        ...
        public DockPane DockTo(INestedPanesContainer container)
        {
            ...
            if ((container.DockState == UPlan.Frame.DockForm.DockState.DockLeft) || (container.DockState == UPlan.Frame.DockForm.DockState.DockRight))
            {
        ...
        public void DockTo(UPlan.Frame.DockForm.DockPanel panel, DockStyle dockStyle)
        {
            ...
            {
                this.DockState = UPlan.Frame.DockForm.DockState.DockTop;
            }
            else if (dockStyle == DockStyle.Bottom)
            {
                this.DockState = UPlan.Frame.DockForm.DockState.DockBottom;
            }
            else if (dockStyle == DockStyle.Left)
            {
                this.DockState = UPlan.Frame.DockForm.DockState.DockLeft;
            }
            else if (dockStyle == DockStyle.Right)
            {
                this.DockState = UPlan.Frame.DockForm.DockState.DockRight;
            }
            else if (dockStyle == DockStyle.Fill)
            {
                this.DockState = UPlan.Frame.DockForm.DockState.Document;
            }
        }
        ...
        public DockPane DockTo(INestedPanesContainer container, DockPane previousPane, DockAlignment alignment, double proportion)
        {
            ...
            {
                pane = this.DockPanel.DockPaneFactory.CreateDockPane(this.DockPanel.DummyContent, (UPlan.Frame.DockForm.FloatWindow) container, true);
            }
            else
            {
        ...
        public DockPane Float()
        {
            ...
            {
                IDockContent firstContent = this.GetFirstContent(UPlan.Frame.DockForm.DockState.Float);
                if (firstContent == null)
                {
                    this.DockPanel.ResumeLayout(true, true);
                    return null;
                }
                floatPaneFromContents = this.DockPanel.DockPaneFactory.CreateDockPane(firstContent, UPlan.Frame.DockForm.DockState.Float, true);
            }
        ...
        public void FloatAt(Rectangle floatWindowBounds)
        {
            ...
            this.DockState = UPlan.Frame.DockForm.DockState.Float;
        }

        private IDockContent GetFirstContent(UPlan.Frame.DockForm.DockState dockState)
        {
        ...
        private DockPane GetFloatPaneFromContents()
        {
            ...
            {
                IDockContent content = this.DisplayingContents[i];
                if (content.DockHandler.IsDockStateValid(UPlan.Frame.DockForm.DockState.Float))
                {
        ...
        Rectangle IDockDragSource.BeginDrag(Point ptMouse)
        {
            ...
            if (((this.DockState == UPlan.Frame.DockForm.DockState.Float) || (floatPane == null)) || (floatPane.FloatWindow.NestedPanes.Count != 1))
            {
        ...
        {
            if ((container.DockState == UPlan.Frame.DockForm.DockState.Float) != this.IsFloat)
            {
            ...
            UPlan.Frame.DockForm.DockState dockState = this.DockState;
        ...
        private void InternalConstruct(IDockContent content, UPlan.Frame.DockForm.DockState dockState, bool flagBounds, Rectangle floatWindowBounds, DockPane prevPane, DockAlignment alignment, double proportion, bool show)
        {
            if ((dockState == UPlan.Frame.DockForm.DockState.Hidden) || (dockState == UPlan.Frame.DockForm.DockState.Unknown))
            {
            ...
            this.m_isFloat = dockState == UPlan.Frame.DockForm.DockState.Float;
            ...
            this.m_nestedDockingStatus = new UPlan.Frame.DockForm.NestedDockingStatus(this);
        ...
        private void InternalSetDockState(UPlan.Frame.DockForm.DockState value)
        {
            if (this.m_dockState != value)
            {
                UPlan.Frame.DockForm.DockState dockState = this.m_dockState;
                INestedPanesContainer nestedPanesContainer = this.NestedPanesContainer;
                ...
                if ((focusedContent != null) && ((((this.m_dockState != UPlan.Frame.DockForm.DockState.DockBottomAutoHide) && (this.m_dockState != UPlan.Frame.DockForm.DockState.DockLeftAutoHide)) && (this.m_dockState != UPlan.Frame.DockForm.DockState.DockRightAutoHide)) && (this.m_dockState != UPlan.Frame.DockForm.DockState.DockTopAutoHide)))
                {
        ...
        private void RefreshChanges(bool performLayout)
        {
            if (!base.IsDisposed)
            {
                ...
                if (this.DockState == UPlan.Frame.DockForm.DockState.Float)
                {
        ...
        private void RefreshStateChange(INestedPanesContainer oldContainer, UPlan.Frame.DockForm.DockState oldDockState)
        {
            lock (this)
            {
        ...
        public void RestoreToPanel()
        {
            ...
            for (int i = this.DisplayingContents.Count - 1; i >= 0; i--)
            {
                ...
                if (content2.DockHandler.CheckDockState(false) != UPlan.Frame.DockForm.DockState.Unknown)
                {
        ...
        private void ResumeRefreshStateChange(INestedPanesContainer oldContainer, UPlan.Frame.DockForm.DockState oldDockState)
        {
            this.ResumeRefreshStateChange();
        ...
        internal void SetContentBounds()
        {
            ...
            if ((this.DockState == UPlan.Frame.DockForm.DockState.Document) && (this.DockPanel.DocumentStyle == DocumentStyle.DockingMdi))
            {
        ...
        public DockPane SetDockState(UPlan.Frame.DockForm.DockState value)
        {
            int num;
            IDockContent content2;
            if ((value == UPlan.Frame.DockForm.DockState.Unknown) || (value == UPlan.Frame.DockForm.DockState.Hidden))
            {
                throw new InvalidOperationException(Strings.DockPane_SetDockState_InvalidState);
            }
            if ((value == UPlan.Frame.DockForm.DockState.Float) == this.IsFloat)
            {
        ...
        {
            if ((this.DockState == UPlan.Frame.DockForm.DockState.Unknown) || (this.DockState == UPlan.Frame.DockForm.DockState.Hidden))
            {
                this.SetParent(null);
                this.Splitter.Parent = null;
            }
            else if (this.DockState == UPlan.Frame.DockForm.DockState.Float)
            {
        ...
        public virtual IDockContent ActiveContent
        {
            ...
            set
            {
                if (this.ActiveContent != value)
                {
                    ...
                    if ((this.DockPanel.DocumentStyle == DocumentStyle.DockingMdi) && (this.DockState == UPlan.Frame.DockForm.DockState.Document))
                    {
        ...
        public AppearanceStyle Appearance
        {
            get
            {
                return ((this.DockState == UPlan.Frame.DockForm.DockState.Document) ? AppearanceStyle.Document : AppearanceStyle.ToolWindow);
            }
        }
        ...
        internal Rectangle ContentRectangle
        {
            get
            {
                ...
                int x = displayingRectangle.X;
                int y = (displayingRectangle.Y + (captionRectangle.IsEmpty ? 0 : captionRectangle.Height)) + ((this.DockState == UPlan.Frame.DockForm.DockState.Document) ? tabStripRectangle.Height : 0);
                int width = displayingRectangle.Width;
        ...
        public UPlan.Frame.DockForm.DockWindow DockWindow
        {
            get
            {
                return ((this.m_nestedDockingStatus.NestedPanes == null) ? null : (this.m_nestedDockingStatus.NestedPanes.Container as UPlan.Frame.DockForm.DockWindow));
            }
            set
            {
        ...
        public UPlan.Frame.DockForm.FloatWindow FloatWindow
        {
            get
            {
                return ((this.m_nestedDockingStatus.NestedPanes == null) ? null : (this.m_nestedDockingStatus.NestedPanes.Container as UPlan.Frame.DockForm.FloatWindow));
            }
            set
            {
        ...
        private bool HasCaption
        {
            get
            {
                if ((((this.DockState == UPlan.Frame.DockForm.DockState.Document) || (this.DockState == UPlan.Frame.DockForm.DockState.Hidden)) || (this.DockState == UPlan.Frame.DockForm.DockState.Unknown)) || ((this.DockState == UPlan.Frame.DockForm.DockState.Float) && (this.FloatWindow.VisibleNestedPanes.Count <= 1)))
                {
                    return false;
                }
                return true;
        ...
        public UPlan.Frame.DockForm.NestedDockingStatus NestedDockingStatus
        {
            get
            {
        ...
        private class SplitterControl : Control, ISplitterDragSource, IDragSource
        {
            ...
            private UPlan.Frame.DockForm.DockPane m_pane;

            public SplitterControl(UPlan.Frame.DockForm.DockPane pane)
            {
                base.SetStyle(ControlStyles.Selectable, false);
                this.m_pane = pane;
            }
